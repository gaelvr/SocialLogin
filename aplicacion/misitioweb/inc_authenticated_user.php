...
<body>
	<br /><br />
	<center>
		<h1>Bienvenido <?php echo $user_data->displayName; ?></h1>
		<br />
		<br /> 
		...
		<table width="600" border="0" cellpadding="2" cellspacing="2">
		  <tr>
			<td valign="top"><fieldset>
				...
				<table width="100%" border="0" cellpadding="2" cellspacing="2"> 
				  ...
				  <tr>
					<td nowrap valign="top"><div align="right"><strong>URL de perfil</strong></div></td>
		  ...
		  <tr>
			<td valign="top" align="right">
				...
				<a href="?logout=<?php echo $adapter->id; ?>">Salir</a>
			</td>
		  </tr>
		</table>
